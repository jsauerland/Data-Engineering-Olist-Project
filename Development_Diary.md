...
5/2/2023: Created 'SQL_Queries.py'

5/5/2023: Added data questions added to 'SQL_Queries.py':
...
5/22/23: Created a stored procedure that will create a new flat table that joins together olist_orders, olist_order_items,  olist_order_payments into one table. This will be considered an analytical table that will be queried often


5/23/23: Developed a DBT connection to BigQuery / GCP. Configured the new model so it will be materialized as a table, and a second model as a view. 
